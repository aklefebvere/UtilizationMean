...
# arg from applescript that gets the location of the app file
# [:-18] slices off /runciscoutil.app since it's not needed
fileloc1 = sys.argv[2][:-18]
...
# Write into the new xlsx file
# "Abstract class 'ExcelWriter' with abstract methods instantiated" seems to be a pylint bug
with pd.ExcelWriter(cwdfinal) as writer:
